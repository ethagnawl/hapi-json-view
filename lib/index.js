...
internals.json.prototype.array = function(array, callback) {
  var self = this;
  ...
  array.forEach(function(item) {
    ...
    self.content.push(json.content);
  });
};
...
internals.json.prototype.partial = function (partial, context) {
  ...
  for (var helper in internals.helpers) {
    context[helper] = internals.helpers[helper];
  }

  Vm.runInContext(internals.partials[partial], context);
};

exports.registerHelper = function(name, helper) {
  internals.helpers[name] = helper;
};
